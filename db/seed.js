...
const users = [
  { email: 'chalupa@apa.org', password: '1234', name: 'Chalupa', picture: '/img/chalupa.png', description: '' },
...
User.create(users, () => console.log(chalk.green(`--- Seeded ${users.length} pups successfully. ---`)));
