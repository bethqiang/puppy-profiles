...
const users = [
  { email: 'chalupa@apa.org', password: '1234', name: 'Chalupa', picture: '/img/chalupa.png', description: 'I\'m a happy young adult and a real people-pleaser, and would love to share a home with a fun active family.' },
  ...
  { email: 'dodger@apa.org', password: '1234', name: 'Dodger', picture: '/img/dodger.png', description: 'I enjoy the finer things in life: treats, lounging with my people, sunbathing and doggie massages.' },
  ...
  { email: 'kent@apa.org', password: '1234', name: 'Kent', picture: '/img/kent.png', description: 'I\'m a people pleaser, but I\'ll also do just about anything for a treat, whether it be agility or doing easy things like sitting.' },
